<div id="userPhrasesWizard">
    <ul class="nav" style="display: none;">
        <li><a class="nav-link" href="#step-1">Step 1<br /><small>Generate phrase</small></a></li>
        <li><a class="nav-link" href="#step-2">Step 2<br /><small>Confirm phrase</small></a></li>
        <li><a class="nav-link" href="#step-3">Step 3<br /><small>Confirm password</small></a></li>
        <li><a class="nav-link" href="#step-4">Step 4<br /><small>Status</small></a></li>
    </ul>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <label class="twolocal-input">
                        <input class="watchme" placeholder=" " type="text" name="phrases" for="phrases" required>
                        <span>Phrase</span>
                    </label>
        ...
        <div id="step-3" class="tab-pane" role="tabpanel">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <label class="twolocal-input">
                        @if($isTemporarySecretPhrase)
                            <input class="watchme" placeholder="" type="text" name="password" for="password" required data-for="secret-phrase">
                            <span>Secret phrase</span>
                        @else
                            <input class="watchme" placeholder="" type="password" name="password" for="password" required>
                            <span>Password</span>
                        @endif
                    </label>
