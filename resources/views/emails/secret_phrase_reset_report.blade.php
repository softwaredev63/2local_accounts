                ...
                <tr>
                    <td style="font-family: Arial; text-align: center; padding: 24px; border-left: #f3f3f3 solid 1px; border-right: #f3f3f3 solid 1px; text-align: center;"
                        ...
                        <p
                            ...
                            The platform finished the "reset user secret phrase" script. Here are the results:
                        </p>
                        @foreach ($resetResults as $resetResult)
                        <p
                            style="font-size: 14px; font-weight: 700; letter-spacing: 0.1px; margin-top: 0; margin-bottom: 4px; line-height: 28px; color: #787878; text-align: left">
                            {{ $resetResult['email'] }}: {{ $resetResult['status'] }}
                        </p>
                        @endforeach
                    </td>
                </tr>
